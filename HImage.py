...
# ========================
'''
Generate thumbs in separate thread to prevent blocking, and Multithread/Multiprocess the image conversion..? https://stackoverflow.com/questions/26460852/how-to-limit-item-text-length-in-qlistwidgetitem

Multithreaded thumb saving? Actually the slow part is the image load.. Server probably isnt helping here. Can we multithread?
Not straightforward in python. Could try with a separate script using multiprocessing
https://docs.python.org/2/library/multiprocessing.html
https://stackoverflow.com/questions/15675043/multiprocessing-and-gui-updating-qprocess-or-multiprocessing
https://stackoverflow.com/questions/40808078/runtimeerror-and-ioerror-when-using-multiprocessing-in-a-pyqt-script
https://stackoverflow.com/questions/40825685/pyqt4-how-can-i-use-multiprocessing-by-clicking-a-pushbutton
https://stackoverflow.com/questions/40808078/runtimeerror-and-ioerror-when-using-multiprocessing-in-a-pyqt-script
